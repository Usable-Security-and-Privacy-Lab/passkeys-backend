...
router.post('/transactions', isAuthenticated, async function (req, res, next) {
  ...
  const json = {
    ...
    "status": status,
    "note": note,
    "dateCreated": parseInt(transactionRow.date_created),
    "dateCompleted": parseInt(transactionRow.date_complete),
    "audience": audience,
    "actor": {
      "id": req.user.id,
  ...
  if (transactions == null) {
    ...
    for (const transaction of transactions) {
      ...
      let transactionJSON = {
        ...
        "dateCreated": parseInt(transaction.date_created),
        "dateCompleted": parseInt(transaction.date_completed),
